...
public final class ServerWebExchangeUtils {
	...
	/**
	 * dubbo调用时的服务名，用这个注册中心查找服务
	 */
	public static final String DUBBO_SERVICE_NAME_ATTR = qualify("dubboServiceName");

	/**
	 * dubbo调用时的URI，用这个配置中心查找接口映射
	 */
	public static final String DUBBO_SERVICE_URI_ATTR = qualify("dubboServiceUri");
