...
public class NettyRoutingFilter implements GlobalFilter, Ordered {
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		String serviceName = exchange.getRequiredAttribute(DUBBO_SERVICE_NAME_ATTR);
		String serviceUri = exchange.getRequiredAttribute(DUBBO_SERVICE_URI_ATTR);

		log.info("我是NettyRoutingFilter的filter方法，我被调用了");

		if(!StringUtils.isEmpty(serviceName) && !StringUtils.isEmpty(serviceUri)) {
